...
def migrate_logs_ath():
    ...
    query = "Select la_id, la_ra_id, la_er_id, la_fecha from log_ath"

    cursor_m.execute(query)

    for (la_id, la_ra_id, la_er_id, la_fecha) in cursor_m:
        cursor_p.execute(
            'INSERT INTO repair_athrepairlog (id, repair_id, status_id, date) VALUES (%s, %s, %s, %s)',
            (la_id, la_ra_id, la_er_id, la_fecha))
...
def migrate_logs_idegis():
    ...
    query = "Select li_id, li_ri_id, li_er_id, li_fecha from log_idegis"

    cursor_m.execute(query)

    for (li_id, li_ri_id, li_er_id, li_fecha) in cursor_m:
        cursor_p.execute(
            'INSERT INTO repair_idegisrepairlog (id, repair_id, status_id, date) VALUES (%s, %s, %s, %s)',
            (li_id, li_ri_id, li_er_id, li_fecha))
